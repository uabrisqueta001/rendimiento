...
int paquete::getFromSource() const
{
    return this->fromSource;
}

void paquete::setFromSource(int fromSource)
{
...
const char * paquete::getSource() const
{
    return this->source.c_str();
}

void paquete::setSource(const char * source)
{
    this->source = source;
}

int paquete::getHopCount() const
{
    return this->hopCount;
}

void paquete::setHopCount(int hopCount)
{
